...
plot.ccep = function(H=NULL, SC=NULL, D=3, main='', 
                     xlim=c(0,1), ylim=c(0,0.5), lwd=1, col=1)
{
  ...
  cont_name = paste('../Data/limits/continua-N',factorial(D),'.q1', sep='')
  trozos_name = paste('../Data/limits/trozos-N',factorial(D),'.q1', sep='')
