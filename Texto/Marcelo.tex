...
Felipe, Brião, Torres e todos os colegas do curso e do LaCCAN.

Ao colega Joao Borges pela grande contribuição na implementação.

A todos os colegas da UFAL que direta ou indiretamente contribuiram para este trabalho, no LCCV, NTI e na gesão central da universidade. E ainda a todos que sempre inquiriam acerca do desenvolvimento deste trabalho.

Aos professores do curso de Modelagem Computacional do Conhecimento.
...
E finalmente aos meus orientadores, Heitor Ramos e Alejandro Frery sem os quais este trabalho não teria se concretizado, obrigado pelo incentivo, pela disponibilidade e pela paciência. 
