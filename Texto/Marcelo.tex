...
Com o intuito de consolidar essa possibilidade, aplicamos o teste de Kolmogorov-Smirnov a pares de sequências comparáveis, porém verificamos que duas das fontes geradoras são realmente irrelevantes, as duas fontes físicas.

%Descartada a influência da fonte geradora na nossa análise
...
\begin{abstract}
\noindent
Our starting point is the desire to verify the statistical feasibility of sequences of observations are white noise in the plane ($H\times C$).
