...
A figura~\ref{Fig:ConfidInt_estacionaria_1k_t10} mostra os pontos característicos da sequência de valores estacionários obtida com $\beta=1$, para $D=3,4,5,6$ e $\tau=10$.
